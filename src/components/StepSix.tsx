...
const StepSix: React.FC<StepSixProps> = ({ dateDetails, onRestart }) => {
  return (
    <div className="step-container">
      ...
      >
        <img
          src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExNTMybWFoaHg3bHN0aGoyNGU1azB6cHc3aGVveTR5bDU5cXg1dWI2byZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/12noFudALzfIynHuUp/giphy.gif"
          alt="See you soon"
      ...
      <div
        className="w-full max-w-md mx-auto glass-card p-6 mb-6 animate-slide-up"
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1">
                <div
                  className="h-2 bg-date-primary rounded-full"
                  style={{ width: `${dateDetails.excitementLevel * 10}%` }}
                ></div>
                <span className="text-sm text-gray-600">
                  {dateDetails.excitementLevel}/10
                </span>
              </div>
            </div>
          </div>
      ...
      <div
        className="w-full flex justify-center mt-2 animate-slide-up"
        style={{ animationDelay: "100ms" }}
      ></div>
    </div>
  );
